...
$(document).ready(function () {
    ...
    function generateHistory() {
      ...
      for (
        ...
        //on click event, diaplsys current and five day forcast and saves to LocalStorage
